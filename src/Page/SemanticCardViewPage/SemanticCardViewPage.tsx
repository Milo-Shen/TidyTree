...
import SemanticChart from "../../Component/SemanticChart/SemanticChart";

// Import Utils
import { mock_org_chart_data } from "../../utils/mock_org_chart_data";

export default function SemanticCardViewPage() {
  // ref hook
  ...
  const fetchCards = useCallback(async () => {
    ...
    let raw_data = mock_org_chart_data(15, 5, true, 176, 290);
